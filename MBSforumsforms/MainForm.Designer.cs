namespace MBSforumsforms
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.bttnEditPost = new System.Windows.Forms.Button();
			...
			// bttnPost
			// 
			this.bttnPost.Location = new System.Drawing.Point(320, 374);
			...
			// bttnLike
			// 
			this.bttnLike.Location = new System.Drawing.Point(680, 374);
			...
			this.totalLikes.Location = new System.Drawing.Point(720, 427);
			...
			this.lblPostName.BackColor = System.Drawing.SystemColors.Control;
			...
			// bttnEditPost
			// 
			this.bttnEditPost.Location = new System.Drawing.Point(440, 374);
			this.bttnEditPost.Name = "bttnEditPost";
			this.bttnEditPost.Size = new System.Drawing.Size(116, 50);
			this.bttnEditPost.TabIndex = 21;
			this.bttnEditPost.Text = "Edit";
			this.bttnEditPost.UseVisualStyleBackColor = true;
			this.bttnEditPost.Visible = false;
			this.bttnEditPost.Click += new System.EventHandler(this.bttnEditPost_Click);
			// 
			// bttnRemove
			// 
			this.bttnRemove.Location = new System.Drawing.Point(560, 374);
			this.bttnRemove.Name = "bttnRemove";
			this.bttnRemove.Size = new System.Drawing.Size(116, 50);
			this.bttnRemove.TabIndex = 22;
			this.bttnRemove.Text = "Remove";
			this.bttnRemove.UseVisualStyleBackColor = true;
			this.bttnRemove.Visible = false;
			...
			this.Controls.Add(this.bttnEditPost);
